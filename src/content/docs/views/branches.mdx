---
title: Branches
description: The tip commit of the selected branch on the left, local branches on the right.
---
...
## Reading a branch's history

Press `enter` to open the [log](/views/log/) on the branch under the cursor without checking it out. `esc` there comes back to this list.
